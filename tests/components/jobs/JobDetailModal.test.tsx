...
vi.mock("../../../src/components/jobs/TraceabilityBlock", () => ({
...
const job = {
  ...
  status_history: [{ from_status: null, to_status: "open" as const, changed_at: "2026-03-18T00:00:00.000Z" }],
  application_ops: {
    role_id: 1,
  ...
  latest_desirability_score: {
    ...
    total_score: 7.4,
    factor_breakdown: [
      { factor_id: 1, factor_name: "Growth", weight: 0.4, score: 8, reasoning: "Good", fallback_used: true },
    ],
...
describe("JobDetailModal", () => {
  it("renders loading and error states", () => {
    render(<JobDetailModal {...baseProps} detailError="Failed detail" loadingDetail job={null} />);
